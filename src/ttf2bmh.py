...
def main():
    ...
    parser.add_argument('-s','--fontsize', default='32', choices=['8', '9', '10', '11', '12', '16', '24', '32', '40', '48', '56', '64', 'all'], help='Fontsize (Fontheight) in pixels. Default: 32')
    ...
    if len(sys.argv) == 1:
        ...
        font_heights = [8, 9, 10, 11, 12, 16, 24, 32, 40, 48, 56, 64]
        font_yoffsets = [0, 0, 0, 3, 0, 3, 6, 5, 7, 8, 9, 10]
